...
from congress.views import state_detail_view, senate_bill_detail_view, senator_detail_view, state_create_view, senator_create_view, senate_bill_create_view, state_list_view
